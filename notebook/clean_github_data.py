...
nw_repos = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12factor_repo_info')
el_repos = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12fa_repo_info')
...
nw_commits = pd.read_csv('../data/raw/12factor_commits.tsv', sep='\t')
el_commits = pd.read_csv('../data/raw/12fa_commits.tsv', sep='\t')
...
nw_issues = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12factor_issues')
el_issues = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12fa_issues')
...
nw_deps = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12factor_dependencies')
el_deps = pd.read_excel('../data/raw/DesktopWebApps.xlsx', '12fa_dependencies')
...
nw_comments = pd.read_csv('../data/raw/12factor_comments.tsv', sep='\t')
el_comments = pd.read_csv('../data/raw/12fa_comments.tsv', sep='\t')
