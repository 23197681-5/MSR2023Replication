...
el = so[so['Tags'].str.contains('<twelve-factor>|<12factor>|<12-factor>|<twelve-factor-app>|<12-factor-app>|<twelvefactorapp>')]

# nw tags ['node-webkit', 'nw.js', 'nedb', 'nwjs']
nw = so[so['Tags'].str.contains('<12factor>|<12-factor>|<twelve-facetor>')]
